// TODO: Need to deal with empty page -- i.e. default page styles x_x
// TODO: Inverse images (both <img> and CSS background-image)
// TODO: Inverse border and outline color
...
rules.forEach(function (_rule) {
  if (_rule && !_rule.cssText.match(/inherit|transparent|rgba/)) {
    // Create a rule
    var rule = new Rule(_rule);

    // Invert the colors
    rule.invert('color');
    rule.invert('background-color');
